...
import { CampaignCreateForm, campaignCreateSchema } from 'schemas/campaign-create-schema';

interface Props {
  defaultValues?: Partial<CampaignCreateForm>;
  onSubmit: SubmitHandler<CampaignCreateForm>;
}

export default function InfoForm({ defaultValues, onSubmit }: Props) {
  ...
  // Watch all required fields to check if form is complete
  ...
  // Watch categoryType to reset categoryName when it changes
  const categoryType = watch('categoryType');
  const missionKeywords = watch('missionKeywords');

  const handleCategoryTypeChange = (value: '방문' | '배송') => {
