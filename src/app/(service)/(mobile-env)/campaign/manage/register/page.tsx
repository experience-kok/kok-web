...
import CampaignRegisterContainer from './_components/campaign-register-container';
import ImageUpload from './_components/sections/image-upload';
...
export default function CampaignRegisterPage() {
  ...
  //       {/* 이미지 등록 영역 */}
  //       <ImageUpload preview={imagePreview} onFileChange={handleImageUpload} />
